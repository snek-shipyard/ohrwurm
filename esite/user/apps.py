...
def define_ohrwurm_groups(sender, **kwargs):
    ...
    supervisor_permissions = [
        # User permissions
        Permission.objects.get_or_create(codename="can_add_members", name="Can add ohrwurm members", content_type=user_ct)[0],
        Permission.objects.get_or_create(codename="can_delete_members", name="Can delete ohrwurm members", content_type=user_ct)[0],
